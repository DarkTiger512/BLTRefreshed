...
| `command.auction` | `!auction` | `AuctionItem` | 1 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.equip` | `!equip` | `EquipHero` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.hero` | `!hero` | `HeroFeatures` | 0 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.smithweapon` | `!smithweapon` | `SmithItem` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.itemstats` | `!itemstats` | `ItemStats` | 1 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.buyattribute` | `!buyattribute` | `AttributePoints` | 1 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.info` | `!info` | `CampaignInfo` | 0 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.rejuvenate` | `!rejuvenate` | `Rejuvenate` | 1 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.leaderboard` | `!leaderboard` | `Leaderboard` | 0 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.reinforce` | `!reinforce` | `ReinforceAction` | 1 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.transfer` | `!transfer` | `TransferAction` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
...
| `command.upgrade` | `!upgrade` | `UpgradeAction` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.family` | `!family` | `FamilyManagement` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.logs` | `!logs` | `CampaignLogs` | 0 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
