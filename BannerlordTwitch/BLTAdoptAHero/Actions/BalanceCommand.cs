...
namespace BLTAdoptAHero
{
    public class BalanceCommand : ICommandHandler
    {
        ...
        public void Execute(ReplyContext context, object config)
        {
            ...
            { ActionManager.SendReply(context, "{=BLTBalanceUnavailable}Joining bonuses are available during battle missions.".Translate()); return; }
            ActionManager.SendReply(context, mission.BalanceSummary());
        }
    }
}
